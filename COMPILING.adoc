...
The build process uses Gradle, which you do *not* need to download. FastAsyncWorldEdit is a multi-module project with four active modules:
...
* FastAsyncWorldEdit for Fabric in **worldedit-fabric/build/libs**
